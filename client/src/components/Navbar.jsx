  ...
  return (
    <header>
      <nav className={iconActive ? "nav-active" : ""}>
        <h2 className="nav-logo"><NavLink to="/">HealthCare</NavLink></h2>
        <ul className="nav-links">
          <li><NavLink to="/">Home</NavLink></li>
          <li><NavLink to="/doctors">Doctors</NavLink></li>
          {token && user.isAdmin && <li><NavLink to="/dashboard/users">Dashboard</NavLink></li>}
          {token && !user.isAdmin && (
            <>
              <li><NavLink to="/appointments">Appointments</NavLink></li>
              <li><NavLink to="/notifications">Notifications</NavLink></li>
              <li><NavLink to="/applyfordoctor">Apply for doctor</NavLink></li>
          ...
          {!token ? (
            ...
            <li><span className="btn" onClick={logoutFunc}>Logout</span></li>
          )}
        </ul>
      </nav>
